                        ...
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal" method="POST" action="register">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input name="pwd" type="text" class="form-control" placeholder="Email ID">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <!-- <button type="submit" class="btn btn-info text-right">Forgot password</button> -->
                                        <a href="forgot-password.jsp" class="pull-right">Forgot Password</a>
                                        </div>
                                </div>
                            </form>
